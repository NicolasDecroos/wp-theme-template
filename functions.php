...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('home-featured', 150, 150, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
// Custom Excerpts
// Create 20 Word Callback for Index page Excerpts, call using custom_excerpt('archive_length');
function archive_length($length) 
{
    return 20;
}

// Create 40 Word Callback for Custom Post Excerpts, call using custom_excerpt('home_length'); 
function home_length($length)
{
    return 40;
}
...
// Load Custom script on specific page (conditional scripts)
...
// Add Actions
add_action('wp_print_scripts', 'custom_conditional_scripts'); // Add Conditional Page Scripts
add_action('get_header', 'enable_threaded_comments'); // Enable Threaded Comments
add_action('widgets_init', 'my_remove_recent_comments_style'); // Remove inline Recent Comment Styles from wp_head()
add_action('init', 'custom_pagination'); // Add our Custom Pagination
